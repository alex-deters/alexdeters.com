...
<svelte:head>
	<title>Education | Alexander Deters</title>
</svelte:head>
...
<html lang="en" class={selected ? selected : ''}>
    <body class="latte bg-base">
        ...
        <thead class="text-md text-text uppercase">
            <tr class="border-b border-t border-overlay0">
                <th scope="col" class="py-3 px-6 bg-base border-l border-overlay0">
                    Relevant Coursework
                </th>
                <th scope="col" class="py-3 px-6 bg-base border-r border-l border-overlay0 ">
                    Materials
                </th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr class="border-b border-overlay0">
                <th scope="row" class="py-4 px-6 font-medium text-text  bg-base border-r border-l border-overlay0">
                    Intro to Functional Analysis (Graduate / Crosslisted)
                </th>
                <td class="py-4 px-6 bg-base border-r border-overlay0">
            ...
            <tr class="border-b border-overlay0">
                <th scope="row" class="py-4 px-6 font-medium text-text  bg-base border-r border-l border-overlay0">
                    Measure Theory and Integration (Graduate / Crosslisted)
                </th>
                <td class="py-4 px-6 bg-base border-r border-overlay0">
