    ...
    <body class="latte bg-base">
        <div class="mx-6 md:mx-20 2xl:mx-[30rem] mt-6 md:mt-8 font-proxima text-text">
            ...
            <img class="hidden float-right w-2/5 md:w-1/4 rounded-md shadow ml-4"  alt="Alex">
                ...
                <p>I'm a quantum computing experimentalist in <a target="_blank" class="font-bold text-mauve" href="https://rsl.yale.edu/">Rob Schoelkopf's group</a>. My current work particularly focuses on maturing FPGA based quantum control solutions via the RFSoC board and researching techniques for improving linearity in microwave signal generation. I'm an undergraduate at Yale University, where I dual major in physics and math.</p><br>
