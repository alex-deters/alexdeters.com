...
<html lang="en" class={selected ? selected : ''}>
    <body class="latte bg-base">
        <div class="mx-6 md:mx-20 2xl:mx-[30rem] mt-6 md:mt-8 font-proxima text-text">
            ...
            <p class="mt-4 text-center md:text-left"> <b>Quantum Simulation</b> @ <a target="_blank" href="https://greiner.physics.harvard.edu/" class="font-bold text-mauve">Greiner Lab</a>  &nbsp;&#8226;&nbsp;  Atomic Physics,  Quantum Control, & FPGA Design</p>
            ...
            <img class="hidden float-right w-2/5 md:w-1/4 rounded-md shadow ml-4"  alt="Alex">
                ...
                <p> I was previously in <a target="_blank" class="font-bold text-mauve" href="https://rsl.yale.edu/"> Robert Schoelkopf's </a> group at Yale where I worked on an FPGA based quantum control system based on the Xilinx RFSoC board and researched techniques for improving linearity in microwave signal generation. Before that I worked in <a target="_blank" class="font-bold text-mauve" href="https://www.yecl.org/">Lin Zhong's group</a>, where I developed and implemented a schema for automatically generating Verilog code and synthesized device firmware for quantum error correction codes across an FPGA network.<br><br>

                I also worked in <a target="_blank" class="font-bold text-mauve" href="https://painterlab.caltech.edu//">Oskar Painter's Lab</a> as part of the Caltech SURF fellowship, where I created a Python library automating design, simulation, and post-processing in Sonnet and applied it towards designing an array of qubits with varied SQUID geometries for flux noise spectroscopy. </p><br>
